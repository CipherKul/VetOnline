    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto max-w-5xl px-4">
        <div className="flex flex-col md:flex-row justify-end">
          {/* Left side */}
          <div className="md:w-1/3 mb-6 md:mb-0 pr-0 md:pr-8 flex flex-col justify-center items-center text-center">
            <div className="flex flex-col items-center space-y-4">
              <p className="text-gray-500 text-sm">Följ upp och svar</p>
              <h2 className="text-2xl font-bold text-[#004E49]">
          ...
          <div className="md:w-2/3 border-l border-gray-200 pl-0 md:pl-8">
            <div className="mb-4 ml-4">
              <h3 className="text-teal-800 font-sm mb-2">+ Vad är RecceptOnline?</h3>
              <h3 className="text-teal-800 font-sm mb-2">+ Hur fungerar RecceptOnline?</h3>
              <h3 className="text-teal-800 font-sm mb-2">+ Var kan jag hämta ut mitt läkemedel?</h3>
              <h3 className="text-teal-800 font-sm mb-2">- Vilka läkemedel/behandlingar erbjuder ni på RecceptOnline?</h3>
              <h3 className="text-teal-800 font-sm mb-2">- Vad krävs för att få använda tjänsten?</h3>
            </div>
            ...
            <div className="mb-4 ml-4">
              <h3 className="text-teal-800 font-sm mb-2">+ Vad kostar det?</h3>
              <h3 className="text-teal-800 font-sm mb-2">+ Hur lång tid tar det från jag får mitt recept?</h3>
            </div>
            
            <div className="ml-4">
              <a href="#" className="text-[#004E49] font-medium border-b-2 border-[#004E49] hover:border-transparent transition-colors">
                Se fler frågor
              </a>
            </div>
          </div>

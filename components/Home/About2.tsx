...
export default function About2() {
  return (
    <section className="bg-white md:bg-[#F3FFF6] w-full py-10 md:py-20">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex flex-col justify-between md:flex-row items-center">
          ...
          <div className="w-full md:w-[45%] flex flex-col mb-6 md:mb-0">
            ...
            <h3 className="text-2xl mt-2 md:text-4xl text-[#004E49]">
              Så här enkelt får du
            </h3>
            <h3 className="text-2xl md:text-4xl text-[#004E49]">

    ...
    <nav className="bg-[#004E49] text-sm text-white p-2">
      <div className="container mx-auto flex justify-between items-center">
        <div className="text-xl ml-4 p-4 font-bold">
          <Image src="/images/landing/logo.png"
           alt="VetOnline" 
        ...
        <nav className="hidden md:flex ml-150 space-x-8">
          <Link href="#" className="hover:underline">Fakta & råd</Link>
          <Link href="#" className="hover:underline">Hur går det till?</Link>
          <Link href="#" className="hover:underline">Frågor & svar</Link>
